...
public class MostViewed_Frag extends Fragment{
    CardView cOne;
    CardView cTwo;
    CardView cThree;
    CardView cFour;
    CardView cFive;
private Newest_Frag.OnFragmentInteractionListener newestLitsner;
...
public void onAttach(Context context){
        ...
        if(context instanceof Newest_Frag.OnFragmentInteractionListener){
        newestLitsner = (Newest_Frag.OnFragmentInteractionListener) context;
        }
        }
